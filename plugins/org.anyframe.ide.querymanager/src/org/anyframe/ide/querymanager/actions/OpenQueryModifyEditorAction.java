...
public class OpenQueryModifyEditorAction extends AbstractQueryManagerAction {
	...
	public OpenQueryModifyEditorAction() {
		super(
				MessagePropertiesLoader.view_explorer_action_editqueryeditor_title,
				MessagePropertiesLoader.view_explorer_action_editqueryeditor_desc,
				MessagePropertiesLoader.image_explorer_editorquery);
	}
