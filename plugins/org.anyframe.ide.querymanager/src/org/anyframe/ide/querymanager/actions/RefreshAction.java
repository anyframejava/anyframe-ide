...
public class RefreshAction extends AbstractQueryManagerAction {
	...
	public RefreshAction() {
		super(
				MessagePropertiesLoader.view_explorer_action_refresh_title,
				MessagePropertiesLoader.view_explorer_action_refresh_desc,
				MessagePropertiesLoader.image_explorer_action_refresh);
	}
