...
<queryservice xmlns="http://www.anyframejava.org/schema/query/mapping" 
  ...
  <queries>
	<query id="create${pojo.shortName}" isDynamic="true" mappingStyle="upper">
		<statement>
		<![CDATA[
	...
	<query id="update${pojo.shortName}" isDynamic="true" mappingStyle="upper">
		<statement>
		<![CDATA[
	...
	<query id="remove${pojo.shortName}" isDynamic="true" mappingStyle="upper"> 
		<statement>
		<![CDATA[
	...
	<query id="find${pojo.shortName}ByPk" isDynamic="true" mappingStyle="upper">
		<statement>
		<![CDATA[
			SELECT 
	...
	<query id="find${pojo.shortName}List" isDynamic="true" mappingStyle="upper">
		<statement>
		<![CDATA[
			SELECT 
				<#list columnList as columnName>${pojoNameLower}.${columnName.toUpperCase()}<#if columnName_has_next>, </#if></#list> 
