...
import org.anyframe.ide.eclipse.hudson.HudsonGenServlet;
...
/**
 * TestCase Name : HudsonGenServletTestCase <br>
 * <br>
 * [Description] : Test for Component 'HudsonGenServlet'<br>
 * [Main Flow]
 * <ul>
 ...
 * </ul>
 */
public class HudsonGenServletTestCase extends TestCase {
	
	private HudsonGenServlet servlet = new HudsonGenServlet();
