...
public class XmlFileUtil {
    ...
    public static void saveObjectToXml(Object xmlContents,
        ...
        try {
            ...
            ExceptionUtil.showException(MessageUtil
                .getMessage("exception.log.findfile"), IStatus.ERROR, e);
        } catch (IOException e) {
            ExceptionUtil.showException(MessageUtil
                .getMessage("exception.log.iofile"), IStatus.ERROR, e);
        }
    }
    ...
    public static void replaceStringXMLFile(File existingFile, String nameInComment,
        ...
        ReplaceRegExp regExpTask =
            (ReplaceRegExp) antProject.createTask("replaceregexp");
        ...
        String stringWithProperLineEndings =
            adjustLineEndingsForOS(replaceString);
        replaceData.setValue(stringWithProperLineEndings);
        replaceData.execute();
        
        try {
            XMLPrettyPrinter.prettyPrintFile(getDefaultTidy(), existingFile, existingFile, true);
        } catch (IOException e) {
            ExceptionUtil.showException(MessageUtil
                .getMessage("exception.log.parsejtidy"), IStatus.ERROR, e);
        }
    }
