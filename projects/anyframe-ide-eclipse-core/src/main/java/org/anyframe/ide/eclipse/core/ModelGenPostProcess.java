...
/**
 * This is a ModelGenPostProcess class.
 * @author Changje Kim
 * @author Sooyeon Park
 */
public class ModelGenPostProcess implements PostProcess {


    private CommandVO vo = null;

    public ModelGenPostProcess(CommandVO vo) {
        this.vo = vo;
    }
            ...
            public void run() {
                try {
                    ...
                    ExceptionUtil.showException(MessageUtil
                        .getMessage("editor.exception.timesleep"), IStatus.ERROR, e);
                }
