...
public class AnyframeMavenLaunchConfiguration {
    ...
    public static String MAVEN_LAUNCH_CONFIGURATION_TYPE =
        "org.anyframe.ide.eclipse.core.Maven2LaunchConfigurationType";

    public static String MAVEN_MAIN_TYPE = "org.codehaus.classworlds.Launcher";

    public static String ATTR_MAVEN_HOME =
        "org.anyframe.ide.eclipse.core.maven.home";

    public static String ATTR_COMMAND_VO =
        "org.anyframe.ide.eclipse.core.maven.command.vo";

    public static String ATTR_MESSAGE_DIALOG =
        "org.anyframe.ide.eclipse.core.message.dialog";
    ...
    public ILaunchConfiguration createLaunchConfiguration(String goal,
        ...
        try {
            ...
            String executeCommand =
                "Executing [mvn " + goal + "] in " + basedir;
            ILaunchConfigurationWorkingCopy workingCopy =
                launchConfigurationType.newInstance(null, vo.getCommand());

            ExceptionUtil.showException("[COMMAND] " + executeCommand,
                IStatus.INFO, null);
            ...
            workingCopy.setAttribute(
                ...
                projectName);
            workingCopy.setAttribute(
                IJavaLaunchConfigurationConstants.ATTR_PROGRAM_ARGUMENTS, goal);
            ...
            if (vo.getCommand().equals(CommandUtil.CMD_CREATE_PROJECT)
                || vo.getCommand().equals(CommandUtil.CMD_CHANGE_DB + " after creation"))
            ...
            ExceptionUtil.showException(
                "failed to create maven launch configuration", IStatus.ERROR,
                ex);
        }
        return null;
    }
