Anyframe Java Core, release 5.5.0.RC1 (2012.10)
------------------------------------------------
...
2) Available Plugins
   ...
   . MySingle Plugin : anyframe-mysingle-pi-1.0.2.jar
...
Anyframe Java Core는 라이센스 정책으로 Apache Licence, Version 2.0 (http://www.apache.org)을 채택한다. 단, Anyframe Java Core내에서 사용된 외부 오픈 소스의 경우 원 오픈 소스의 라이센스 정책을 따른다.
