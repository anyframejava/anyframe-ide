...
public interface Constants {
	...
	String SETTING_HOME = "." + FILE_SEPERATOR + ".settings" + FILE_SEPERATOR + "anyframe";
	String DFAULT_TEMPLATE_HOME = SETTING_HOME + FILE_SEPERATOR + "templates";

	String METADATA_FILE = "project.mf";

	//String COMMON_CONFIG_PREFS_FILE = "." + FILE_SEPERATOR + ".settings" + FILE_SEPERATOR + "org.anyframe.ide.common.prefs";
	String COMMON_CONFIG_PREFS_FILE = ".settings" + FILE_SEPERATOR + "org.anyframe.ide.common.prefs";
	...
	String DB_POSTGRESQL_URL = "jdbc:postgresql://<server>:<port>/<database_name>";
	...
	// for online runtime - check whether enterprise version(online) is
	// installed or not
