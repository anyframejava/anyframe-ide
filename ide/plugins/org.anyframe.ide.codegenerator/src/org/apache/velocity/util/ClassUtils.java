...
public class ClassUtils {
    ...
    public static Class getClass(String clazz) throws ClassNotFoundException
    {
         ...
         */
    	// org common 플러그인의 ClassLoader 를 이용하여 타 플러그은에서 Velocity 사용할때 충돌 이슈 발생하는것을 제거
//      ClassLoader loader = Thread.currentThread().getContextClassLoader();
        ClassLoader loader = CodeGeneratorActivator.getDefault().getClass().getClassLoader();
        if (loader != null)
        {
            try
            {
