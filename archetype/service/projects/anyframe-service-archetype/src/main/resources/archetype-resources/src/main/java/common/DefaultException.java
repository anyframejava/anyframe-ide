...
/**
 * This DefaultException class contains various constructor for different
...
public class DefaultException extends BaseException {
	 ...
	 */
	public DefaultException(final MessageSource messageSource,
	 ...
	 *            the exception that is wrapped in this exception
	 */
	public DefaultException(final String message, final Throwable exception) {
